...
foreach ($lines as $key => &$line) {// on parcours chaque ligne du tableau
    ...
    if ($data[0] == $id_quizz) {// si l'identifiant du quiz correspond
        ...
        $data[5] = "Terminé"; //nous modifions le statut du quiz
        ...
        break; // nous sortons de la boucle après avoir trouvé le quiz
    }
}


file_put_contents($csv_file, implode('', $lines));// nour remplaçons le fichier csv par le nouveau tableau
?>
